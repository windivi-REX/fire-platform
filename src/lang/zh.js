export default {
  route: {
    ...
    examManage: '考试维护',
    examineeManage: '考生管理',
    terminalChange: '考试状态监控',
    testScore: '考试成绩',
    examPaperManage: '试卷维护',
    examYanShiRedirect: '我的考试',
    statisticAnalysis: '统计分析',
    arrangeExamInitRedirect: '排号设备',
    codeSettingInitRedirect: '考试设备',
    printInitRedirect: '打印设备',
    callSignInitRedirect: '叫号设备',
    // 智慧消防平台
    equipmentMonitori: '设备监控',
    walletManage: '钱包管理',
    systemManage: '系统管理',
    newsManage: '新闻管理',
    patrolManage: '巡检管理',
    ...
    newsCenter: '新闻中心',
    deviceGroup: '设备组管理',
    patrolEquipment: '巡检设备管理',
    patrolEquipmentType: '巡检设备类型管理',
    patrolPlan: '巡检计划',
    patrolTask: '巡检任务',
    patrolRecord: '巡检记录',
    maintainTask: '维修任务',
